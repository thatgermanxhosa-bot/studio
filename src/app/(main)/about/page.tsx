    ...
    <>
      <section className="bg-card py-20 text-center">
        <div className="container">
          <h1 className="text-4xl md:text-5xl font-black uppercase">About Pichulik Studios</h1>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            We are a multidisciplinary creative studio passionate about crafting compelling narratives that resonate and inspire.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 text-center">
        <div className="container">
          <h2 className="text-3xl md:text-4xl font-bold">Ready to Create Impact?</h2>
