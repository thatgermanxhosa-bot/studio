...
describe('ForPersonalWithBackgroundLayout', () => {
  it('should render children without a background image for a non-specific path', () => {
  ...
  it('should render with the correct background for the contact page', () => {
    (require('next/navigation').usePathname as jest.Mock).mockReturnValue('/contact');
    render(
      <ForPersonalWithBackgroundLayout>
  ...
  it('should render with the correct background for the about page', () => {
    (require('next/navigation').usePathname as jest.Mock).mockReturnValue('/about');
    render(
      <ForPersonalWithBackgroundLayout>
  ...
  it('should render with the video background for the wedding enquiry page', () => {
    (require('next/navigation').usePathname as jest.Mock).mockReturnValue('/wedding-enquiry');
    render(
      <ForPersonalWithBackgroundLayout>
  ...
  it('should render with the correct background for the services page', () => {
    (require('next/navigation').usePathname as jest.Mock).mockReturnValue('/services');
    render(
      <ForPersonalWithBackgroundLayout>
