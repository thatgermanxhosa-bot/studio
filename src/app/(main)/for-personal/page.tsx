...
export default function ForPersonalPage() {
    ...
    <>
      <section className="bg-card py-20 text-center">
        <div className="container">
          <h1 className="text-4xl md:text-5xl font-black uppercase">For Personal Projects</h1>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            We love working with individuals to capture life's important moments with creativity and style.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">How We Can Help</h2>
        ...
        <div className="container grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Your story is unique, and it deserves to be told with passion and precision. We are committed to making your personal project a beautiful reality.
            </p>
      ...
      <section className="py-24 text-center">
        <div className="container">
          <h2 className="text-3xl md:text-4xl font-bold">Have an Idea?</h2>
          <p className="mt-4 max-w-xl mx-auto text-lg text-muted-foreground mb-8">
            Let's book a session and start bringing your vision to life.
          </p>
