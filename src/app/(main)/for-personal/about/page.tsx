...
const whyPartnerItems = [
    {
        ...
        description: "Specialized in capturing your personal life moments beautifully"
    },
    {
            ...
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-3 gap-16 items-start">
                    ...
                    <div className="lg:col-span-2">
                        <div className="mb-12">
                            <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">We are a boutique video studio, delivering specialized creative for individuals.</h1>
                ...
                <div className="mt-20 text-center bg-card p-8 md:p-12 rounded-lg">
                    <h2 className="text-2xl md:text-3xl font-bold mb-4">Have an Idea?</h2>
                    ...
                    <Button asChild size="lg" className="uppercase font-bold tracking-widest px-8">
                        <Link href="/for-personal/bookings">Book a Session</Link>
                    </Button>
                </div>
            </div>
        </section>
